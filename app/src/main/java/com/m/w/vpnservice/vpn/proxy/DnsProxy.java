...
import com.m.w.vpnservice.vpn.dns.Question;
import com.m.w.vpnservice.vpn.dns.Resource;
import com.m.w.vpnservice.vpn.dns.ResourcePointer;
...
//                Log.d("Tanck", "DNS包:" + new String(packet.getData()));
